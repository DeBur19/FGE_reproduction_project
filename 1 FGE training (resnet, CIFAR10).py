...
resnet_cifar10_fge = models.resnet152(pretrained=False, **{'num_classes' : 10})
resnet_cifar10_fge.load_state_dict(torch.load('resnet_cifar10_32ep_1.pt'))
resnet_cifar10_fge = resnet_cifar10_fge.cuda()

criterion = nn.CrossEntropyLoss()

optimizer = optim.SGD(resnet_cifar10_fge.parameters(), lr=0.01, weight_decay=0.0005, momentum=0.9)
optimizer.load_state_dict(torch.load('resnet_cifar10_32ep_1_opt.pt'))

C = 2
dir_name = 'resnet_cifar10_fge_1'
a_1 = 0.05
a_2 = 0.0005


predictions_ensemble1, test_labels, \
resnet_cifar10_fge_1_acc, resnet_cifar10_fge = train(resnet_cifar10_fge, 
                                                   optimizer, 
                                                   criterion, 
                                                   dataset_loader_train, 
                                                   dataset_loader_test, 
                                                   8, 10, dir_name, C, a_1, a_2)
#print('Ensemble 1 accuracy:', resnet_cifar10_fge_1_acc)
