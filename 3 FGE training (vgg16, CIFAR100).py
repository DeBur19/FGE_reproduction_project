...
predictions_ensemble1_100, test_labels100, vgg16_cifar100_fge_1_acc, vgg16_cifar100_fge = train(vgg16_cifar100_fge,
                                                   optimizer, 
                                                   criterion, 
...
predictions_ensemble2_100, test_labels100, vgg16_cifar100_fge_2_acc, vgg16_cifar100_fge = train(vgg16_cifar100_fge,
                                                   optimizer, 
                                                   criterion, 
                                                   dataset_loader_train, 
                                                   dataset_loader_test, 
...
predictions_ensemble3_100, test_labels100, vgg16_cifar100_fge_3_acc, vgg16_cifar100_fge = train(vgg16_cifar100_fge,
                                                   optimizer, 
                                                   criterion, 
                                                   dataset_loader_train, 
                                                   dataset_loader_test, 
