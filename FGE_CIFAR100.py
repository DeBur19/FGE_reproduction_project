...
# First model:
resnet_cifar100_fge = models.resnet152(pretrained=False, **{'num_classes' : 100})
resnet_cifar100_fge.load_state_dict(torch.load('resnet_cifar100_32ep_1.pt'))
resnet_cifar100_fge = resnet_cifar100_fge.cuda()

criterion = nn.CrossEntropyLoss()

optimizer = optim.SGD(resnet_cifar100_fge.parameters(), lr=0.01, weight_decay=0.0005, momentum=0.9)
optimizer.load_state_dict(torch.load('resnet_cifar100_32ep_1_opt.pt'))

C = 2
dir_name = 'resnet_cifar100_fge_1'
a_1 = 0.05
a_2 = 0.0005

predictions_ensemble1_100, test_labels100, \
resnet_cifar100_fge_1_acc, resnet_cifar100_fge = train(resnet_cifar100_fge, 
                                                   optimizer, 
                                                   criterion, 
...
#print('Ensemble 1 accuracy:', resnet_cifar100_fge_1_acc)


# Second model:
resnet_cifar100_fge = models.resnet152(pretrained=False, **{'num_classes' : 100})
resnet_cifar100_fge.load_state_dict(torch.load('resnet_cifar100_32ep_2.pt'))
resnet_cifar100_fge = resnet_cifar100_fge.cuda()

criterion = nn.CrossEntropyLoss()

optimizer = optim.SGD(resnet_cifar100_fge.parameters(), lr=0.01, weight_decay=0.0005, momentum=0.9)
optimizer.load_state_dict(torch.load('resnet_cifar100_32ep_2_opt.pt'))

C = 2
dir_name = 'resnet_cifar100_fge_2'
a_1 = 0.05
a_2 = 0.0005

predictions_ensemble2_100, test_labels100, \
resnet_cifar100_fge_2_acc, resnet_cifar100_fge = train(resnet_cifar100_fge, 
                                                   optimizer, 
                                                   criterion, 
                                                   dataset_loader_train, 
                                                   dataset_loader_test, 
...
# print('Ensemble 2 accuracy:', resnet_cifar100_fge_2_acc)