...
resnet_cifar100 = models.resnet152(pretrained=False, **{'num_classes' : 100})
resnet_cifar100 = resnet_cifar100.cuda()

criterion = nn.CrossEntropyLoss()

optimizer = optim.SGD(resnet_cifar100.parameters(), lr=0.01, weight_decay=0.0005, momentum=0.9)

sched = MultiStepLR(optimizer, milestones=[20,30], gamma=0.1)

train_log, val_log, resnet_cifar100_1_acc, resnet_cifar100 = train(resnet_cifar100, optimizer, criterion, dataset_loader_train, dataset_loader_test, 40, sched, 31,  1, 100)

torch.save(resnet_cifar100.state_dict(), 'resnet_cifar100_40ep_1.pt')
...
sched = MultiStepLR(optimizer, milestones=[20,30], gamma=0.1)
train_log, val_log, resnet_cifar100_2_acc, resnet_cifar100 = train(resnet_cifar100, optimizer, criterion, dataset_loader_train, dataset_loader_test, 40, sched, 31,  2, 100)
torch.save(resnet_cifar100.state_dict(), 'resnet_cifar100_40ep_2.pt')
